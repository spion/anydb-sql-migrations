...
var Promise:{
    ...
    each<R, U>(values:R[], mapper:(item:R, index:number, arrayLength:number) => Promise.Thenable<U>): Promise<void>;
    each<R, U>(values:R[], mapper:(item:R, index:number, arrayLength:number) => U): Promise<void>;
